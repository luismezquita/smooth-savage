...
export const getBenefitStyle = (benefit) => {
    ...
    if (key.includes('body balance') || key.includes('body-balance')) return "bg-gradient-to-r from-rose-400 to-red-500 text-white shadow-sm border border-white/20";
    ...
    if (key.includes('clean nutrition') || key.includes('clean-nutrition')) return "bg-gradient-to-r from-cyan-400 to-blue-500 text-white shadow-sm border border-white/20";
