    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <Link to="/benefits" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white mb-8 transition-colors font-medium">
                <ArrowLeft className="w-5 h-5" /> Back to Explore Benefits
            </Link>
            ...
            >
                ...
                <p className="text-xl md:text-2xl text-white/90 max-w-3xl relative z-10 font-medium">
                    {category.tagline}. Every item below has been organically assigned to natively support this premium health goal.
                </p>
            ...
            {superfoods.length > 0 && (
                <div className="mb-10">
                    <div className="flex items-center gap-3 mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Potent Superfoods</h2>
                        <span className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 py-1 px-3 rounded-full text-sm font-bold">{superfoods.length} items</span>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 xl:gap-8">
